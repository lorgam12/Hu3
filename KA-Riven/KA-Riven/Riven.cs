...
using Settings = KA_Riven.Config.Modes.Draw;

namespace KA_Riven
{
    internal static class Riven
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if (Settings.DrawR && Settings.DrawReady ? SpellManager.R2.IsReady() : Settings.DrawR)
            {
                Circle.Draw(Settings.RColor, SpellManager.R2.Range, 1f, Player.Instance);
            }
        }
    }
}
