...
namespace KA_Riven.DMGHandler
{
    ...
    public class DangerousSpells
    {
        public static List<DangerousSpell> Spells = new List<DangerousSpell>
        {
            ...
            new DangerousSpell(Champion.Blitzcrank, SpellSlot.Q, true),
            ...
            new DangerousSpell(Champion.Elise, SpellSlot.E, false),
            ...
            new DangerousSpell(Champion.Jax, SpellSlot.E, false),
            ...
            new DangerousSpell(Champion.Lux, SpellSlot.Q, false),
            ...
            new DangerousSpell(Champion.Nami, SpellSlot.Q, false),
            ...
            new DangerousSpell(Champion.Olaf, SpellSlot.E, false),
